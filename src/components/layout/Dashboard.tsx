...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="bg-white p-3 md:p-4 rounded-xl shadow-sm">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          ...
          <div className="flex items-center justify-between w-full sm:w-auto gap-2 sm:gap-3">
            <button className="flex items-center text-xs md:text-sm font-medium text-primary">
      ...
      <button className="fixed right-4 bottom-4 md:right-6 md:bottom-6 bg-primary text-white rounded-full p-3 shadow-lg hover:bg-opacity-90 transition-all lg:hidden">
